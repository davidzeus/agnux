...
# =====================================================================
async def autogenerarNuevaTool(nombreFuncion: str, codigoPython: str, descripcionDocstring: str) -> str:
    nombre_limpio = nombreFuncion.strip().lower().replace(" ", "-").replace("_", "-")
...
async def ejecutarHerramientaLocal(nombre: str, argumentos: dict = None, terminalId: str = None, userId: str = None) -> str:
    ...
    if terminalId: argumentos["__terminal_id"] = terminalId
    if userId: argumentos["__user_id"] = userId
    
    if nombre == "autogenerarNuevaTool":
        return await autogenerarNuevaTool(**argumentos)
